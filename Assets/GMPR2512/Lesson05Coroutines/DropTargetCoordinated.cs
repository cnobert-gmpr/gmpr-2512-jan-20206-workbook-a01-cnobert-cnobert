...
{
    public class DropTargetCoordinated : MonoBehaviour
    {
        [SerializeField] private Color _hitColour = Color.darkTurquoise;
        [SerializeField] private float _hideDelay = 0.1f, _resetDelay = 2f;

        // 6. Coordinated timed drop target reset [3 pts] - 
        // At least three drop targets that function as a single bank. 
        // When all are struck, they reset together automatically after a short, 
        // fixed delay.
        [SerializeField] private GameObject _friend01, _friend02;
        // using the above data members, you can use 
        // _friend01.activeInHiearchy
